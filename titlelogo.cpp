...
// マクロ定義
//*****************************************************************************
#define TITLELOGO_DEFAULTPOSX		(980.0f)			// タイトルロゴの標準位置X
#define TITLELOGO_DEFAULTPOSY		(180.0f)			// タイトルロゴの標準位置Y
#define TITLELOGO_SIZEX				(300.0f)			// タイトルロゴの幅
#define TITLELOGO_SIZEY				(200.0f)			// タイトルロゴの高さ
#define TITLELOGO_SPEED				(10.0f)				// タイトルロゴの移動速度
